            ...
            <div class="box">
                ...
                <div class="box-body" >
                    <form action="" method="GET">
                        <div class="row" style="margin-bottom: 20px;display: flex;align-items: end;margin-left: 130px;">
                            <div class="col-lg-1"></div>
                            <div class="col-lg-3">
                            <label>Employees</label>
                                <select class="form-control select2" name="emp" style="width: 100%;" autofocus tabindex="1" >
                    ...
                    if($emp == 'all'){
                        $sql="SELECT * FROM attendance WHERE date BETWEEN '$from' AND '$to' ORDER BY id DESC ";
                    }else{
                        $sql="SELECT * FROM attendance WHERE emp_id='$emp' AND date BETWEEN '$from' AND '$to' ORDER BY id DESC ";
                    }
                    ?>
                    </div>
