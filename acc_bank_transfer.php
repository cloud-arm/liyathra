...
?>
                                            ...
                                            <div class="col-md-10">
                                                <div class="form-group">
                                                    <div class="input-group">
                                                        ...
                                                        <select class="form-control " name="bank" id="b_sel" onchange="bank_select()"
                                        ...
                                        <form method="POST" action="acc_bank_transfer_save.php">           
                                            <div class="row" >
                                                ...
                                                <div class="col-md-10" >
                                                    ...
                                                    for($i=0; $row = $result->fetch(); $i++){ 
                                                        $id=$row['id'];
                                                        if($id!=1){$style='style="display: none;"';} ?>
                                    ...
                                    <table id="example2" class="table table-bordered table-hover" style="border-radius: 0;">
                                        ...
                                        <tbody>
                                            ...
                                            <tr id="re_<?php echo $row['id']; ?>">
                                                ...
                                                <td> <span id="<?php echo $row['id']; ?>" class="deposit_btn btn btn-success" title="Click to Deposit"> <i class="fa-solid fa-money-bill-transfer"></i></span></td>                                                       
                                                ...
                                                <div class="col-md-10">
                                                    <div class="form-group">
                                                        <div class="input-group">
                                                            ...
                                                            <select class="form-control " name="bank" id="bank_sel1" onchange="bank_withdraw()"
                                                                style="width: 100%;" tabindex="1" autofocus>
                                                ...
                                                <div class="col-md-10">
                                                    <div class="form-group">
                                                        <div class="input-group">
                                                            ...
                                                            <select class="form-control " name="bank" id="bank_sel2" onchange="bank_charge()"
                                                                style="width: 100%;" tabindex="1" autofocus>
    ...
    <script type="text/javascript">
        ...
        function check_charge(){
            ...
            if(0 >= txt || blc < txt){$('#btn_ch').attr("disabled","");}
            else{$('#btn_ch').removeAttr('disabled');}           
        }
        ...
        function check_withdraw(){
            ...
            if(0 >= txt || blc < txt){$('#btn_wi').attr("disabled","");}
            else{$('#btn_wi').removeAttr('disabled');}           
        }
        ...
        function acc_type(type){
            ...
            if(type=='cash'){$('#cash_box').css('display','block')}else{$('#cash_box').css('display','none')}
            if(type=='chq'){$('#chq_box').css('display','block')}else{$('#chq_box').css('display','none')}
        }
        ...
        function check_deposit(){
            ...
            if(0 >= txt || blc < txt){$('#btn_de').attr("disabled","");}
            else{$('#btn_de').removeAttr('disabled');}
        ...
        $(".deposit_btn").click(function() {
            ...
            $.ajax({
                ...
                success: function(res) {
                    console.log(res);
                    $('#re_'+res).animate({backgroundColor: "#fbc7c7"}, "fast")
