                                    ...
                                    <tbody>
                                        ...
                                        ?>
                                            <tr id="re_<?php echo $row['id']; ?>">
                                                ...
                                                <td align="center"> <a href="#" id="<?php echo $row['id']; ?>" class="realize_btn btn btn-success" title="Click to Realize"> <i class="fa-solid fa-money-bill-transfer"></i></a></td>
                                                <td align="center"> <a href="#" id="<?php echo $row['id']; ?>" class="return_btn btn btn-danger" title="Click to Return"> <i class="fa-solid fa-rotate-left"></i> </a></td>
