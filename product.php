...
<body class="hold-transition skin-blue sidebar-mini">
    ...
    <div class="content-wrapper">
        ...
        <section class="content">
                            ...
                            <div class="col-md-6">
                                <form method="post" action="product_save.php">
                                    <div class="row">
                                        ...
                                        <div class="col-md-6 product_type" style="display: none;">
                                            <div class="form-group">
                                                <label>Cost Price</label>
                                                <input type="number" step=".01" value="0.00" name="cost" class="form-control" tabindex="4" autocomplete="off">
                                            </div>
                                        </div>
            ...
            <?php } else { ?>
                <div class="box box-info" style="background: rgba(var(--bg-content-light), 0.2) !important;">
                    <div class="box-header with-border">
                        <h3 class="box-title">Product Update</h3>
                        <div class="box-tools pull-right">
                            <a href="product.php?id=0" class="btn btn-info pull-right" style="--tx-opacity: 0.75 !important;border: 0;"> <i class="fa fa-times" style="font-size: 20px;"></i> </a>
                        </div>
                    </div>
                            ...
                            <div class="col-md-6">
                                <form method="post" action="product_save.php">
                                    <div class="row">
                                        ...
                                        <div class="col-md-6 serve_type" style="display: <?php if ($type == 'Service') {
                                                                                                echo 'block';
                                                                                            } else {
                                                                                                echo 'none';
                                                                                            } ?>;">
                                        ...
                                        <div class="col-md-6 product_type" style="display: none;">
                                            <div class="form-group">
                                                <label>Cost Price</label>
                                                <input type="number" step=".01" value="<?php echo $cost; ?>" name="cost" class="form-control" tabindex="4" autocomplete="off">
                                            </div>
                                        </div>
                                        ...
                                        <div class="col-md-6 product_type" style="display: none;">
                                            <div class="form-group">
                                                ...
                                                <select class="form-control" name="brand" style="width: 100%;" tabindex="3">
                                                    ...
                                                    for ($i = 0; $row = $result->fetch(); $i++) {
                                                    ?>
                                                        <option value="<?php echo $row['id']; ?>" <?php if ($brand == $row['id']) {
                                                                                                        echo 'selected';
                                                                                                    } ?>> <?php echo $row['name']; ?>
                                                        </option>
                                                    <?php
