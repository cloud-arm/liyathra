...
<body class="bg-light customer" style="overflow-y: scroll;">
    <div class="container-fluid container-md mt-4">
        <div class="box px-2 mb-0 mt-3 ">
            <div class="box-header px-0 mb-0">
                ...
                <a class="nav-link border-0 btn fs-1 d-md-none" aria-current="page" href="invoice.php?id=<?php echo $job ?>&invo=<?php echo $invo ?>"><i class="fa-solid fa-cart-shopping"></i></i></a>
                ...
                <a class="nav-link btn border-0 bg-theme px-3 fs-4 py-2 d-none d-md-block" aria-current="page" href="invoice.php?id=<?php echo $job ?>&invo=<?php echo $invo ?>"><i class="fa-solid fa-cart-shopping me-2"></i></i>Invoice</a>
            </div>
        </div>
    </div>
    ...
    <div class="container-lg box-body category mt-5 room-container" style="overflow-x: scroll;">
        <table>
            <tr>
                <td>
                    <label for="type0" class="room">
                        <input type="radio" name="type" class=" cat_fill type" id="type0" value="0" checked />
                        <svg xmlns="http://www.w3.org/2000/svg" viewBox="0 0 122.88 119.75">
                            <defs>
                                <style>
                                    .cls-1 {
                                        fill-rule: evenodd;
                ...
                <td>
                    <label for="type1" class="room">
                        <input type="radio" name="type" class=" cat_fill type" id="type1" value="1" />
                ...
                <td>
                    <label for="type2" class="room">
                        ...
                        <svg id="Layer_1" data-name="Layer 1" xmlns="http://www.w3.org/2000/svg" viewBox="0 0 116.36 122.88">
    ...
    <script>
        $(document).ready(function() {
            ...
            xmlhttp.open("GET", "item_get.php?unit=3&invo=<?php echo $invo; ?>", true);
            xmlhttp.send();
