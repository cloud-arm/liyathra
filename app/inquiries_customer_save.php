...
if ($type == 'cus_check') {
    ...
    if ($cus_id > 0) {
        ...
        header("location: inquiries_save.php?cus=$cus_id&invo=$invo");
    } else {
        ...
        header("location: inquiries_customer_add.php?cus=$cus_id");
    }
} else
...
if ($type == 'cus_add') {
    ...
    header("location: inquiries_save.php?cus=$id&invo=$invo");
}
